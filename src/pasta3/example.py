...
#print(verifica_existe_prioridade(listaIps1, ipsIndv), "Têm de ser 1")
#print(verifica_existe_prioridade(listaIps2, ipsIndv), "Tê de ser 0")
#print(verifica_existe_prioridade(listaIps2, ipsIndv), "Tê de ser 0")
#teste1 = ordena_por_nodes(listaIps3)
